...
namespace techMADT2.Areas.Admin.Controllers
{
    ...
    public class AppUsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Surname,Email,Phone,Password,UserName,IsActive,IsAdmin,CreatedDate,UpdateDate")] AppUser appUser)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Surname,Email,Phone,Password,UserName,IsActive,IsAdmin,CreatedDate,UpdateDate")] AppUser appUser)
        {
            if (id != appUser.Id)
            {
                return NotFound();
